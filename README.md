...
- Una **pieza extra de reto: la tuerca**, un bloque 3 × 3 con el centro hueco. Al fijarse deja un agujero de una celda que solo se puede tapar con otra pieza, así que complica bastante cerrar líneas. Sale con la misma frecuencia que el resto (1 de cada 8).
